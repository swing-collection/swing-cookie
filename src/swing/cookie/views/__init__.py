...
Each module contains a single class-based view following the
one-symbol-per-file convention.

"""

from .view_consent_export import ConsentExportView
from .view_consent_update import ConsentUpdateView
from .view_cookie_banner import CookieBannerView
...
from .view_cookie_policy import CookiePolicyView
