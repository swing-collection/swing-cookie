...
class UserCookieConsentModel(models.Model):
    ...
    necessary = models.BooleanField(
        default=True, help_text=_("Consent for necessary cookies.")
    )
    analytics = models.BooleanField(
        default=False, help_text=_("Consent for analytics cookies.")
    )
    marketing = models.BooleanField(
        default=False, help_text=_("Consent for marketing cookies.")
    )

    created_at = models.DateTimeField(
        auto_now_add=True,
        help_text=_("The timestamp when the consent was recorded."),
    )
    updated_at = models.DateTimeField(
        auto_now=True,
        help_text=_("The timestamp when the consent was last updated."),
    )
